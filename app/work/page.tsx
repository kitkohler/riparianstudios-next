...
export const metadata: Metadata = {
  ...
  description: 'Brand films, campaign videos, and documentary work by Riparian Studios.',
};
    ...
    <div style={{ background: '#fff', minHeight: '100vh' }}>
      <div style={{ background: '#1A1408', padding: '88px 48px 72px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(244,239,230,0.4)', marginBottom: 14 }}>Documentary &amp; video production</div>
